...
export function CarrouselSlider({ updateActive, data, act }: CarrouselSliderProps) {
    ...
    return (
        <motion.div ref={carrousel} className="bg-white bg-opacity-30 absolute md:bottom-10 md:left-12 bottom-4 right-6 md:w-[75%] w-[85%] h-32 rounded-md flex flex-row flex-grow-0 items-center overflow-hidden">
